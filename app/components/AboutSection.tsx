...
const content = [
  ...
  "Web development has provided me with an outlet to combine the two while still solving problems and providing services. On the backend I primarily use NodeJs, MySQL, Mongo, and AWS. While exploring the front end I utilize React coupled with libraries such as Framer Motion and frameworks like Next.js.",
  "The possibilities truly are endless and I always look forward to chasing that end of line.",
];
