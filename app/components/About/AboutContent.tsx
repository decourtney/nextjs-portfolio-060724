      ...
      <div className="mt-12 lg:mt-16 mx-auto 2xl:w-[70%] text-medium space-y-12 lg:space-y-0">
        ...
        <div className="w-fit mx-auto lg:ml-auto lg:mr-[20%] lg:-translate-y-[100px]">
          <Button
            ...
            href="/resume.pdf"
            target="_blank"
            className="text-2xl font-playfairDisplay font-black bg-[hsl(var(--nextui-primary-500))] text-[hsl(var(--nextui-primary-100))] shadow-[0px_0px_5px_0px_hsl(var(--nextui-secondary-100))] hover:text-[hsl(var(--nextui-secondary-100))] hover:border-[hsl(var(--nextui-primary-100))]"
          >
            RESUME
          </Button>
        </div>
