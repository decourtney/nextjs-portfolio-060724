...
const NameSVG = () => {
  return (
    <svg
      ...
      fontSize={36}
    >
      <g transform="matrix(.99845 0 0 1.001177 0.224379-77.954205)">
        <text dx="0" dy="0" transform="translate(10.742967 144.917886)">
          <tspan x="36" y="0">
            ONOVAN
          </tspan>
          <tspan x="36" y="36">
        ...
        <g transform="matrix(.316688 0 0 0.316699-20.1447 68.291597)">
          <path
          ...
          <path
            ...
            transform="matrix(.965926-.258819 0.258819 0.965926-34.520209 47.20402)"
          />
        </g>
      </g>
    </svg>
